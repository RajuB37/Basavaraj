...
public class Scenario7 {
	...
	private static void createTask()
	{
		try
		{
			oPage.getctask1().click();
			Thread.sleep(2000);
			oPage.getctask2().click();
			Thread.sleep(2000);
			oPage.getctask3().sendKeys("challenge");
			Thread.sleep(2000);
			oPage.getctask4().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	private static void deleteTask()
	{
		try
		{
			oPage.getdtask1().click();
			Thread.sleep(2000);
			oPage.getdtask2().click();
			Thread.sleep(2000);
			oPage.getdtask3().click();
			Thread.sleep(2000);
			oPage.getdtask4().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();

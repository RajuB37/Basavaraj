	...
	private static void launchBrowser()
	{
		...
		private static void createProject()
		{
			try
			{
				...
				Thread.sleep(2000);
				oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("Ecommerce");
				Thread.sleep(2000);
				oBrowser.findElement(By.name("projectDescriptionField")).sendKeys("It's a Java Project");
				Thread.sleep(2000);
		...
		private static void createTask()
		{
			try
			{
				...
				Thread.sleep(2000);
				oBrowser.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("challenge");
				Thread.sleep(2000);
		...
		private static void deleteTask()
		{
			try
			{
				oBrowser.findElement(By.xpath("//*[@id=\'"
						+ "taskListBlock\']/div[1]/div[2]/div[1]/table[1]/tbody/tr[1]/td[2]")).click();
				Thread.sleep(2000);
